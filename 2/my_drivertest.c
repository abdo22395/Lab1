...
int my_shift (unsigned char data, unsigned char data_pin, unsigned char clk_pin, bool dir)
{
...
{
    unsigned char bit = dir ? (data & (1 << (7-i))) : (data & (1 << i )); //extrahera biten beroende på riktning 
